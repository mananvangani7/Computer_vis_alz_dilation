...
├── optimizer_comparison_RMSprop_Adagrad_SGD_91pct.ipynb  # SGD achieves 91%; comparison with RMSprop and Adagrad
├── optimizer_check_6class.ipynb                       # Optimizer sweep on dilated CNN — 6-class
├── SGD_90pct.ipynb                                    # SGD-tuned dilated CNN — 90% accuracy checkpoint
├── TL_AD.ipynb                                        # VGG16 + VGG19 transfer learning — initial baseline
